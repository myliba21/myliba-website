...
class Commands
{
    ...
    public function seed(array $args, array $assoc_args): void
    {
        ...
        $pages = [
            ...
            ['Our Trainers', 'our-trainers', $en, 'en', 'Our Trainers', 'Meet the trainers, coaches, and consultants who bring strategy, culture, and high performance into daily work.'],
            ...
            ['Eğitmenlerimiz', 'egitmenlerimiz', $tr, 'tr', 'Eğitmenlerimiz', 'Stratejiyi, kültürü ve yüksek performansı günlük işin içine taşıyan eğitmen, koç ve danışmanlarımızla tanışın.'],
    ...
    private function seed_academy(): void
    {
        $items = [
            [
                ...
                "40 CCE\nCanlı Oturumlar\nUygulamalı Eğitim\nICF Onaylı\nDijital Sertifika\nSüpervizyon",
                "Bilgi ve Farkındalık Modülü | Global hedefleme sistemlerinin tarihsel gelişimi ve analizi; Performans Yönetim Sistemleri içinde hedefleme sistemlerinin kullanımı; OKR, CFR, KPI ve Koçluk bir arada nasıl kullanılır, çevik zihniyet ve Myliba Model; Çeviklik değerleri ve davranış göstergeleri; “Create Culture to Work” kültürel ölçüm modeli ve kültürel gelişim; İlham veren OKR’ler yazmanın formülü; OKR ve KPI farkını anlamak ve birlikte yönetmek; 12 saat eğitim, 4 saat uygulama\nBeceri Geliştirme Modülü | İlham veren OKR’leri yazma becerisini koçluk ile pekiştirme; Güçlü sorular ve etkin dinlemenin hedef belirleme sürecinde kullanımı; İleri bildirimlerle OKR ve KPI yönetimi; Radikal samimi geri bildirimlerle OKR rutinlerinin yönetimi; Takdir-tanıma odaklı sürekli diyalog kurmak ve ilişki geliştirme yönetimi; Myliba Model üzerinden hedef döngülerinin yönetimi; OKR ve Kültür Koçluğu vaka çalışmaları; Ekip koçluğu ve bireysel koçluk; 4 saat eğitim, 12 saat uygulama\nUstalaşma Modülü | Strateji ve stratejik öncelik belirleyerek OKR yazma; Hedeflerin hizalanması, uyumu ve OKR Map; OKR Kapama ve Özdeğerlendirme; “360 Değerler Uyum”, “Keeper Test” vb. araçların kullanımı; Bire-bir görüşmeler ile performans koçluğu; “Lider Kararı” ve kurumsal çalışan kararlarında kullanımı; Birey ve Ekip Dashboard kullanımı; Yeteneklerin belirlenmesi ve yönetimi; 3 saat işbaşı uygulama, 3 saat süpervizyon; Tamamlama sınavı",
            ...
            [
                ...
                "Bilgi ve Farkındalık Modülü | OKR, CFR, KPI ve Koçluk bir arada nasıl kullanılır? Çevik zihniyet ve Myliba Model; Çeviklik değerleri ve davranış göstergeleri; “Grate Culture to Work” kültürel gelişim modeli; İlham veren OKR’ler yazmanın formülü; OKR ve KPI farkını anlamak ve birlikte yönetmek\nBeceri Geliştirme Modülü | İlham veren OKR’leri yazma becerisini pekiştirme; Güçlü sorular ve etkin dinlemenin hedef belirleme sürecinde kullanımı; İleri bildirimlerle OKR ve KPI yönetimi; Radikal samimi geri bildirimlerle OKR rutinlerinin yönetimi; Takdir-tanıma odaklı sürekli diyalog kurmak ve ilişki geliştirme yönetimi; Myliba Model üzerinden hedef döngülerinin yönetimi",
        ...
        if ($academy_page) {
            $this->save_meta($academy_page->ID, [
                ...
                '_myliba_academy_hero_tertiary_url' => '',
                ...
                '_myliba_academy_programs_title' => 'Bilgiden İşbaşında Deneyimlere, İşbaşı Deneyimlerinden Kurumsal Dönüşüme',
                '_myliba_academy_programs_text' => 'Myliba Akademi programları, teorik bilginin ötesine geçerek katılımcılara gerçek kurum hedefleri, canlı oturumlar, uygulamalı çalışmalar ve Myliba platformu üzerinden sürdürülebilir bir gelişim deneyimi sunar.',
    ...
    private function home_meta_defaults(string $language): array
    {
        ...
        return [
            '_myliba_home_builder' => $this->home_builder_defaults(),
            '_myliba_home_hero_slides' => "Performance & Culture Platform | Build the operating system behind high performance. | Myliba brings strategy, goals, actions and culture into one measurable flow, so transformation does not stop at another software rollout. | Contact us | /en/contact/ | Explore Myliba | /en/software/\nMyliba Software | Performance is built every day, not scored once a year. | Keep strategic priorities alive with a platform designed to connect goals, continuous feedback, action and measurable progress. | Request a demo | /en/demo/ | Explore software | /en/software/\nMyliba Academy | The world's first ICF-approved OKR & Culture Coaching program. | Develop the leaders who will turn a strong platform into lasting organizational change through an accredited 40-hour certification journey. | Apply to the program | /en/okr-culture-academy/ | Explore academy | /en/okr-culture-academy/",
