                        ...
                        <article id="hero-slide-<?php echo esc_attr((string) $index); ?>" class="hero-slide <?php echo $index === 0 ? 'is-active' : ''; ?>" data-hero-slide aria-hidden="<?php echo $index === 0 ? 'false' : 'true'; ?>">
                            ...
                            <div class="hero-slide__visual-wrap">
                                ...
                                <?php foreach (array_slice($hero_metrics, 0, 3) as $metric_index => $metric) :
                                    ...
                                    ?>
                                    <div class="hero-slide__metric hero-slide__metric--<?php echo esc_attr($metric_classes[$metric_index]); ?>" aria-hidden="true">
        ...
        case 'trust_bar':
            ...
            <section class="section band trust-section">
                <div class="trust-section__heading">
                    ...
                    <?php if ($logo_posts) : ?>
                        <span><?php echo esc_html(myliba_home_value('trust_logo_label')); ?></span>
                    <?php endif; ?>
                </div>
                <?php if ($logo_posts) : ?>
                ...
                <div class="academy-spotlight">
                    <div class="academy-spotlight__content">
                        ...
                        <div class="academy-spotlight__actions">
                            <a class="myliba-button myliba-button--primary" href="<?php echo esc_url(myliba_page_url('academy')); ?>"><?php echo esc_html(myliba_home_value('academy_button')); ?></a>
                            <a class="myliba-button myliba-button--ghost" href="<?php echo esc_url($demo_url); ?>"><?php echo esc_html(myliba_option('demo_cta_label')); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="performance-tabs" data-home-tabs>
                        ...
                        <?php foreach ($performance_tabs as $index => $row) :
                            ...
                            <div id="performance-panel-<?php echo esc_attr((string) $index); ?>" class="performance-tabs__panel <?php echo $index === 0 ? 'is-active' : ''; ?>" role="tabpanel" aria-labelledby="performance-tab-<?php echo esc_attr((string) $index); ?>" data-home-panel <?php echo $index === 0 ? '' : 'hidden'; ?>>
                                <div><span><?php echo esc_html(str_pad((string) ($index + 1), 2, '0', STR_PAD_LEFT)); ?></span><h3><?php echo esc_html($title); ?></h3><p><?php echo esc_html($text); ?></p><a class="myliba-button myliba-button--primary" href="<?php echo esc_url(myliba_page_url('products')); ?>"><?php echo esc_html(myliba_home_value('performance_button')); ?></a></div>
            ...
            <section class="section final-cta-section">
                <div class="final-cta">
                    ...
                    <div class="final-cta__actions">
                        <a class="myliba-button myliba-button--primary" href="<?php echo esc_url($demo_url); ?>"><?php echo esc_html(myliba_home_value('final_cta_primary_label')); ?></a>
                        <a class="myliba-button myliba-button--ghost" href="<?php echo esc_url(myliba_page_url('contact')); ?>"><?php echo esc_html(myliba_home_value('final_cta_secondary_label')); ?></a>
                    </div>
                </div>
            </section>
            <?php
