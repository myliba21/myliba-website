...
<section class="hero">
    <div class="hero__content">
        <p class="eyebrow"><?php echo esc_html(myliba_meta('_myliba_eyebrow', get_queried_object_id(), __('OKR, KPI, CFR and performance culture', 'myliba'))); ?></p>
        ...
        <div class="dashboard-preview__body">
            ...
            <div class="dashboard-insights">
                <div class="metric-card">
                    <strong><?php echo esc_html(myliba_home_value('metric_1_value', '72%')); ?></strong>
                    <small><?php echo esc_html(myliba_home_value('metric_1_label', __('OKR progress', 'myliba'))); ?></small>
                </div>
                <div class="metric-card">
                    <strong><?php echo esc_html(myliba_home_value('metric_2_value', '148')); ?></strong>
                    <small><?php echo esc_html(myliba_home_value('metric_2_label', __('1:1 notes', 'myliba'))); ?></small>
                </div>
            </div>
    ...
    <div class="card-grid card-grid--three">
        <?php while ($solutions->have_posts()) : $solutions->the_post(); ?>
            <a class="use-case-card" href="<?php the_permalink(); ?>">
                ...
                <strong><?php echo esc_html(myliba_home_value('solution_button', __('See solution', 'myliba'))); ?></strong>
            </a>
        <?php endwhile; wp_reset_postdata(); ?>
    </div>
</section>
