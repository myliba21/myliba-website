    ...
    <section class="software-hero">
        <div class="software-hero__content">
            ...
            <h1><?php echo esc_html($copy('hero_title_start')); ?>
                ...
                <?php echo esc_html($copy('hero_title_end')); ?></h1>
        ...
        <div class="software-hero__visual" aria-label="<?php echo esc_attr($copy('dashboard_aria_label')); ?>">
            <div class="software-screen">
                <div class="software-screen__top">
                    <span class="software-screen__brand"><?php echo esc_html($copy('dashboard_brand')); ?>
                        <small><?php echo esc_html($copy('dashboard_product')); ?></small></span>
                    <div><i></i><i></i><i></i></div>
                </div>
                <div class="software-screen__body">
                    <aside>
                        <?php foreach ($rows('dashboard_nav') as $nav_index => $nav_item): ?>
                            <span
                                class="<?php echo $nav_index === 0 ? 'is-active' : ''; ?>"><?php echo esc_html((string) ($nav_item['label'] ?? '')); ?></span>
                        <?php endforeach; ?>
                    </aside>
                    <div class="software-ninebox">
                        <div class="software-ninebox__head">
                            <div>
                                <small><?php echo esc_html($copy('dashboard_analysis_label')); ?></small><strong><?php echo esc_html($copy('dashboard_title')); ?></strong>
                            </div>
                        ...
                        <span
                            class="software-ninebox__axis software-ninebox__axis--x"><?php echo esc_html($copy('dashboard_axis_x')); ?>
                            →</span>
                        <span
                            class="software-ninebox__axis software-ninebox__axis--y"><?php echo esc_html($copy('dashboard_axis_y')); ?>
                            →</span>
                    </div>
                </div>
            </div>
            <div class="software-floating-card software-floating-card--score">
                <strong><?php echo esc_html($copy('dashboard_score_value')); ?></strong><span><?php echo esc_html($copy('dashboard_score_label')); ?></span>
            </div>
            <div class="software-floating-card software-floating-card--ai"><span>✦
                    <?php echo esc_html($copy('dashboard_ai_label')); ?></span><strong><?php echo esc_html($copy('dashboard_ai_text')); ?></strong>
            </div>
        </div>
    </section>
    ...
    <section id="moduller" class="software-section software-modules">
        <div class="software-section__heading">
            ...
            <p><?php echo esc_html($copy('modules_text')); ?>
                <strong><?php echo esc_html($copy('modules_text_strong')); ?></strong></p>
        </div>
        <div class="software-modules__grid">
            <?php foreach ($modules as $module_index => $module): ?>
                <article>
                    ...
                    <div class="software-module-visual software-module-visual--<?php echo esc_attr((string) ($module_index + 1)); ?>"
                        aria-hidden="true">
                        ...
                        <?php elseif ($module_index === 1): ?>
                            <span style="--value: 72%"></span><span style="--value: 46%"></span><span
                                style="--value: 88%"></span><span style="--value: 62%"></span>
