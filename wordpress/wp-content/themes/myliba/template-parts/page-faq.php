                        ...
                        <div class="faq-hero__header">
                            ...
                            <div class="faq-search-wrapper" role="search">
                                <div class="faq-search-input-group">
                                    ...
                                    <input type="search" id="faq-live-search" class="faq-search-input"
                                        ...
                                        autocomplete="off" />
                                    <button type="button" class="faq-search-clear" id="faq-search-clear"
                                        aria-label="<?php echo esc_attr(myliba_text('Clear search')); ?>" hidden>✕</button>
                                </div>
                    ...
                    <nav class="faq-categories-bar" aria-label="<?php echo esc_attr(myliba_text('FAQ Categories')); ?>">
                        <div class="faq-shell">
                            <div class="faq-categories-list" role="tablist">
                                <button type="button" class="faq-cat-btn is-active" role="tab" aria-selected="true"
                                ...
                                <?php foreach ($categories as $idx => $cat_name):
                                    ...
                                    ?>
                                    <button type="button" class="faq-cat-btn" role="tab" aria-selected="false"
                                        data-filter-category="<?php echo esc_attr($cat_name); ?>">
                                        <span><?php echo esc_html($cat_name); ?></span>
                                        <small class="faq-cat-count"
                                            data-count-target="<?php echo esc_attr($cat_name); ?>"><?php echo $cat_count; ?></small>
                                    </button>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    ...
                    <div class="faq-shell">
                        <div class="academy-v2-faq faq-main-container">
                            <div class="academy-v2-faq__items faq-accordion-list" id="faq-accordion-list">
                                <?php if (!empty($faqs)): ?>
                                    <?php foreach ($faqs as $index => $item):
                                        ...
                                        ?>
                                        <details class="faq-item" data-category="<?php echo esc_attr($cat); ?>"
                            ...
                            <div class="faq-no-results" id="faq-no-results" hidden>
                                ...
                                <p><?php echo esc_html(myliba_text('Try searching with different keywords or switch categories.')); ?>
                                </p>
                                <button type="button" class="myliba-button myliba-button--ghost faq-reset-search-btn"
                            ...
                            <div class="faq-cta-card__aside">
                                <div class="faq-support-box">
                                    <div class="faq-support-box__header">
                                        ...
                                        <h4><?php echo esc_html($copy('cta_contact_title') ?: myliba_text('Direct Contact')); ?>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="faq-support-box__channels">
                                        ...
                                        <a href="<?php echo esc_url('tel:' . preg_replace('/[^\d+]/', '', $support_phone)); ?>"
                                            class="faq-channel-link">
